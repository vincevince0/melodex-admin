...
namespace MelodexAdmin
{
    public partial class Form1 : Form
    {
        ...
        private void chooseLoginBtn_Click(object sender, EventArgs e)
        {
            contentPanel.Controls.Clear();

            Button LoginBtn = new Button();
            LoginBtn.Size = new Size(188, 30);
            LoginBtn.Location = new Point(372, 140);
            LoginBtn.Text = "Login";
            ...
            emailTextBox.Location = new Point(372, 66);
            ...
            passwordTextBox.Location = new Point(372, 100);
        ...
        private void chooseRegisterBtn_Click(object sender, EventArgs e)
        {
            contentPanel.Controls.Clear();
        }
